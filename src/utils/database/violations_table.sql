...
-- Create or replace function to check and alter violations table
...
-- Create function for RPC to find violations by address
...
BEGIN
    IF EXISTS (
        ...
        EXECUTE 'CREATE INDEX IF NOT EXISTS idx_violations__id ON public.violations (_id)';
    END IF;
END $$;
